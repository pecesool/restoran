...
namespace restoran.bdDataSetTableAdapters {
    ...
    public partial class авторизацияTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `авторизация` WHERE ((`Код пользователя` = ?) AND ((? = 1 AND `логин`" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `авторизация` SET `логин` = ?, `пароль` = ? WHERE ((`Код пользователя` = ?" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Код пользователя], логин, пароль FROM авторизация";
        ...
        public virtual int Fill(bdDataSet.авторизацияDataTable dataTable) {
        ...
        public virtual bdDataSet.авторизацияDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bdDataSet.авторизацияDataTable dataTable = new bdDataSet.авторизацияDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bdDataSet.авторизацияDataTable dataTable) {
